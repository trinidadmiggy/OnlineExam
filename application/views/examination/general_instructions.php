			...
			<div class="col-lg-6 col-lg-offset-3">
				<div class="box-exam">
					<div class="box-header with-border">
						<h2 class="text-center" style="margin:0">General Instructions</h2>
					</div>
					<div class="box-body">
						<form method="post"  action="<?= site_url('applicant/examination/verbal')?>">
							...
							<br />	
							<div>
								&emsp;You will indicate your answers by placing an X (<span>&#9746;</span>) in the appropriate answer box for each item. If you wish to change an answer, draw a circle (<span>&#8855;</span>) around your first answer and mark another X for your new answer. Each test in the booklet has special instructions which test administrator will read with you before you begin that part.	
							</div>
							<br />			
							<div>
								&emsp;Are there any questions about the use of the answer sheet?
							</div>
							<br />
							<div>
								<h4>&emsp;DO NOT TURN THIS PAGE UNTIL TOLD TO DO SO.</h4>
							</div>
							<input type="submit" class="btn btn-primary pull-right" value="Take Exam" />
						</form>
					</div>
				</div>
			</div>
